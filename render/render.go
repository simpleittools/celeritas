...
// Page will render the page from the views directory, with the various variables and data
...
// GoPage is used to render go's built-in templating engine
...
// JetPage is used to render the Jet Template Engine
