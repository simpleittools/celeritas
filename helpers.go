...
// RandomString generates a random string of length n from values in the cost randomString
...
// CreateDirIfNotExist creates directories
...
// CreateFileIfNotExists creates files if they do not already exist
